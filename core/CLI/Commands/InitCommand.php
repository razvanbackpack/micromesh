...
class InitCommand extends Command
{
    protected function configure(): void
    {
        $this
            ->setName('init')
            ->setDescription('Initialize the .env file by copying env.example')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $sourceFile = $projectRoot . DIRECTORY_SEPARATOR . 'env.example';
        $destinationFile = $projectRoot . DIRECTORY_SEPARATOR . '.env';
