...
class Asset 
{
    public static string $ASSETS_BASE_PATH = BASEDIR . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR;
    ...
    private static function getManifest(): array
    {
        ...
        $manifest_path = self::$ASSETS_BASE_PATH . 'manifest.json';
