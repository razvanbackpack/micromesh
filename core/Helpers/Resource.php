...
class Resource 
{
    public static string $RESOURCES_BASE_PATH = BASEDIR . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR;
    public static string $BUILD_PATH = BASEDIR . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR;
    public static string $MANIFEST_PATH_FOLDER = BASEDIR . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . '.vite' . DIRECTORY_SEPARATOR . 'manifest.json';
